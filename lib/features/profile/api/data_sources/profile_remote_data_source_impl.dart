...
class ProfileRemoteDataSourceImpl implements ProfileRemoteDataSourceContract {
  ...
  @override
  Future<BaseResponse<ProfileDataModel>> getProfileData() async {
    try {
      final response = await apiClient.getProfileData();
      return SuccessBaseResponse<ProfileDataModel>(data: response);
    } catch (e) {
      return ErrorBaseResponse<ProfileDataModel>(error: e);
    }
  }
