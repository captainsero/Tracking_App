...
void main(List<String> args) {
  ...
  for (final layer in layers) {
    ...
    if (repositoryDir.existsSync()) {
      if (layer == 'domain') {
        File(
          '${repositoryDir.path}/${featureName}_repo.dart',
        ).writeAsStringSync(
          '// TODO: $layer ${_capitalize(featureName)}Repository\n',
        );
      } else {
        File(
          '${repositoryDir.path}/${featureName}_repo_impl.dart',
        ).writeAsStringSync(
